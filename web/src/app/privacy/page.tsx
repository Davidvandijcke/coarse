    ...
    <div style={{ background: "var(--board)", minHeight: "100vh" }}>
      ...
      <main style={{ maxWidth: "720px", margin: "0 auto", padding: "0 2.5rem 6rem" }}>
        ...
        <div style={{ paddingTop: "2.5rem" }}>
          ...
          <div style={sectionStyle}>
            <h2 style={h2Style}>What the LLM provider sees</h2>
            <p style={pStyle}>
              Your paper is sent to the LLM you choose (Claude, GPT, Gemini,
              DeepSeek, Qwen, Kimi, Grok, Llama, and so on) through OpenRouter.
              OpenRouter itself does not log prompts or completions &mdash; only
              anonymous request metadata like token counts and latency.
            </p>
            <p style={pStyle}>
              We send every request with{" "}
              <code style={{ fontFamily: "var(--font-mono, monospace)", color: "var(--chalk-bright)" }}>
                provider.data_collection: &quot;deny&quot;
              </code>
              , which instructs OpenRouter to route only to model providers
              whose policy is to not retain or train on your data. You can
              verify this in{" "}
              <a
                href="https://github.com/Davidvandijcke/coarse/blob/main/src/coarse/llm.py"
                target="_blank"
                rel="noopener noreferrer"
                style={{ color: "var(--blue-chalk)", textDecoration: "underline", textUnderlineOffset: "2px" }}
              >
            ...
            <p style={pStyle}>
              Providers may still keep short-term logs for abuse monitoring
              (typically 30 days or less, auto-deleted). They will not train on
              your paper. The final authority is the provider&rsquo;s own
              terms &mdash; we encourage you to check them if you&rsquo;re
              submitting highly sensitive work, and for maximum control you can
              always run coarse yourself on your own infrastructure.
            </p>
          </div>
