...
export const ko: Messages = {
  ...
  bannerFasterPrefix: "더 빠른 결과를 원하시면 CLI를 사용하세요:",
  ...
  heroManifesto:
    "학술 동료 심사는 무보수 학술 노동으로 돌아갑니다. 누군가는 그것으로 사업을 하기로 했습니다. 우리는 그게 마음에 들지 않았습니다.",

  scoreVsOthers: "다른 AI 리뷰어 대비",
  statCostNum: "< $2*",
  statCostLabel: "리뷰당",
  statCostFootnote: "*보통 그렇습니다 :)",
  statCommentsNum: "20+",
  ...
  compareSuffix:
    "적은 비용으로 범위, 구체성, 깊이에서 더 높은 점수를 받습니다.",
  ...
  emailHelperDisabled:
    "이메일 전송이 일시적으로 중단되었습니다. 제출할 때 리뷰 키를 저장하시고 약 한 시간 후에 다시 확인하세요.",
  emailHelperPrefix:
    "완료되면 이메일로 알려드립니다. 보이지 않으면 스팸 폴더를 확인하세요.",
  ...
  turnstileFailedLine2Prefix: "먼저 페이지를 새로고침해 보세요. 계속되면 ",
  turnstileFailedLine2Mid: " 허용하세요, 대상은 ",
  turnstileFailedLine2Suffix:
    " (콘텐츠 차단기를 끄거나 개인정보 보호 설정을 완화하세요), 또는 다른 브라우저를 사용하세요. 미리보기 URL에서는 배포가 해당 호스트 이름을 Cloudflare Turnstile 위젯 허용 목록에 추가해야 할 수도 있습니다.",
  ...
  explainSubscriptionPart1:
    "전체 coarse 파이프라인을 로컬에서 실행하는 셸 명령을 드립니다, 사용하는 것은 ",
  ...
  explainSubscriptionPart2: "구독으로 LLM 추론을 수행합니다.",
  explainSubscriptionPdf:
    "로컬 Mistral OCR 단계에 대해서만 ~$0.10를 지불합니다(자신의 OpenRouter 키 사용); PDF가 아닌 업로드(.tex, .md, .docx, …)는 OCR을 건너뛰며 OpenRouter 키가 필요 없습니다.",
  ...
  explainDisclaimer:
    "자신의 Claude Code, Codex 또는 Gemini CLI 계정을 사용하여 사용자 컴퓨터에서 로컬로 실행됩니다. coarse.ink는 사용자의 제공자 로그인을 수신하거나 저장하지 않으며, 제공자의 약관, 사용 한도 및 조직 정책이 적용됩니다. coarse.ink는 Anthropic, OpenAI 또는 Google과 제휴 관계가 없습니다.",

  handoffReviewWithPrefix: "리뷰 도구: ",
  handoffModelLabel: "모델",
  handoffEffortLabel: "노력 수준",
  handoffPastePromptPrefix: "이 프롬프트를 다음 터미널에 붙여넣으세요: ",
  handoffPastePromptSuffix: " 터미널:",
  handoffRunHint:
    "에이전트가 coarse-review 스킬을 새로 고치고 전체 리뷰를 로컬에서 실행하며 10–25분이 걸립니다. 제공자 로그인은 사용자 컴퓨터에 그대로 유지됩니다.",
  handoffKeyNeededPrefix:
    "OpenRouter 키가 먼저 사용자 컴퓨터에 있어야 합니다 — 다음을 내보내세요: ",
  handoffKeyEnvVar: "OPENROUTER_API_KEY",
  handoffKeyNeededMid1: ", 또는 다음 파일에 넣으세요: ",
  handoffKeyEnvFile: ".env",
  handoffKeyNeededMid2: " 또는 ",
  handoffKeyConfigFile: "~/.coarse/config.toml",
  handoffKeyNeededSuffix:
    ". 핸드오프 URL이 에이전트의 채팅 로그에 남기 때문에 브라우저를 통해 전달하지 않습니다. 키가 없으면 에이전트가 요청합니다.",
  handoffKeyNotNeeded:
  ...
  errorLoginNoPersist:
    "로그인되었지만 키를 이 탭에 유지할 수 없었습니다. 이 페이지가 새로고침되면 다시 붙여넣어야 합니다.",
  errorLoginFailed:
    "OpenRouter 로그인에 실패했습니다. 다시 시도하거나 키를 수동으로 붙여넣으세요.",
  errorAuthFailed:
    "인증에 실패했습니다. 미리보기 배포에서는 보통 브라우저에 캐시된 Basic Auth 자격 증명이 폼 제출 시 전송되지 않았음을 의미합니다. 탭을 새로고침하고(Cmd/Ctrl+Shift+R) 비밀번호 프롬프트에서 다시 로그인한 후 재시도하세요.",
  errorServiceUnavailable: "서비스를 일시적으로 사용할 수 없습니다 — 잠시 후 다시 시도하세요.",
  errorHttpMid: " (HTTP ",
  errorTurnstileBlockedPrefix:
    "사람 확인 위젯을 불러올 수 없었습니다 — 브라우저 확장 프로그램(Brave Shields, uBlock Origin, Firefox ETP 엄격 모드)이 challenges.cloudflare.com을 차단하고 있을 가능성이 높습니다. 다음에 대해 비활성화해 보세요: ",
  errorTurnstileBlockedSuffix: ", 또는 coarse를 로컬에서 실행하세요: uvx coarse-ink review paper.pdf",
  errorTurnstileWaiting:
    "여전히 사람 확인이 로드되기를 기다리는 중입니다 — 잠시 기다린 후 다시 시도하세요.",
  errorPrepareUpload: "업로드 준비에 실패했습니다",
  errorUploadFailed: "파일 업로드에 실패했습니다 — 다시 시도하세요",
  errorSubmissionFailed: "제출에 실패했습니다",
  errorHandoffFailed: "핸드오프에 실패했습니다",
  launchCommandCopied: "명령이 클립보드에 복사되었습니다. 터미널에 붙여넣으세요.",
  launchOpeningCodex:
    "Codex 데스크톱 앱을 여는 중입니다 — 작성기가 미리 채워져 있어야 합니다. 전송을 누르세요.",
  launchOpeningPrefix: "여는 중: ",
  launchOpeningSuffix: " — 클립보드에서 프롬프트를 붙여넣으세요(⌘V / Ctrl+V).",
  launchDidntOpenSuffix:
    " 데스크톱 앱이 열리지 않았습니다. CLI 버전만 설치한 경우 위 명령을 터미널에 붙여넣으세요.",
